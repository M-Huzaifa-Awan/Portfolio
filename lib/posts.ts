...
export const POSTS: Post[] = [
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        text: "Performance work like this — turning a slow, scaling-poorly app into a fast one — is a big part of what I do. See more of my [work](/#projects) or [reach out](/#contact) if your app is starting to feel the load.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        text: "Reaching for the newest framework is easy. Knowing when **not** to — when to use WebSockets for live preview, when a simple cron job beats a queue, when to build vs. integrate — is judgment. That judgment is what you are paying senior rates for, and it is what saves you from a rewrite in eighteen months.",
      },
      { type: "h2", text: "5. They use AI as leverage, carefully" },
      {
        type: "p",
        text: "The strongest engineers right now use AI to move faster **and** know exactly where it must not be trusted. Building AI into a product safely — structured outputs, guardrails, auditability — is a genuine skill, not a prompt. If a candidate can talk concretely about shipping AI features responsibly, that is a strong modern signal.",
      },
      ...
      {
        type: "p",
        text: "If you are looking for a senior full-stack developer who ticks these boxes — end-to-end ownership, clear communication, and a track record of shipping to production — that is exactly what I offer. Take a look at my [work](/#projects) and [experience](/#experience), or [book a call](/#contact).",
      },
    ],
  },
];
